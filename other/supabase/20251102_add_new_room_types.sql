-- =====================================================
-- MIGRATION: Add New Room Types
-- =====================================================
-- Date: 2025-11-02
-- Purpose: Add new room types to enum and create their specifications
-- New types: chambre_enfant, salle_de_jeux, toilette
-- IMPORTANT: ENUM values must be added outside of transaction
-- =====================================================

-- =====================================================
-- PART 1: ADD NEW VALUES TO room_type ENUM
-- =====================================================
-- NOTE: These ALTER TYPE commands must run OUTSIDE of a transaction
-- They will commit immediately
...
-- Now start transaction for inserting room specifications
BEGIN;

-- =====================================================
-- PART 2: CREATE ROOM SPECIFICATIONS FOR NEW TYPES
-- =====================================================
