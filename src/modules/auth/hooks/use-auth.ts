...
import { SupabaseAuthProvider } from '@/infrastructure/supabase/auth.adapter'
...
import { ManageUserService } from '@/domain/auth/services/manage-user'
import type { SignUpInput, SignInInput, UpdateUserInput } from '@/domain/auth/models/user'
