...
import { ManageImagesService } from '@/domain/images/services/manage-images'
import { GenerateImageService } from '@/domain/images/services/generate-image'
import { SupabaseImagesRepository } from '@/infrastructure/supabase/images.repository'
import { SupabaseImageStorage } from '@/infrastructure/supabase/image-storage.adapter'
import { NanoBananaAIGeneratorClient } from '@/infrastructure/ai/nanobanana-client.adapter'
import type { UploadImageInput, UpdateImageInput, RegenerateImageInput } from '@/domain/images/models/image'
