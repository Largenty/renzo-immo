-- =====================================================
-- MIGRATION: Populate Transformation Types & Style Palettes
-- =====================================================
-- Date: 2025-11-02
...
-- =====================================================
-- PART 1: CREATE TRANSFORMATION TYPES
-- =====================================================
...
-- 1. DÉPERSONNALISATION (Remove furniture)
...
-- 2. HOME STAGING STYLES (Add furniture - these WORK according to user)
INSERT INTO transformation_types (slug, name, description, icon_name, category, allow_furniture_toggle, is_system, is_active) VALUES
...
-- 3. NEW STYLES - Designed to match prompt template format perfectly
INSERT INTO transformation_types (slug, name, description, icon_name, category, allow_furniture_toggle, is_system, is_active) VALUES
...
-- =====================================================
-- PART 2: CREATE STYLE PALETTES
-- =====================================================
-- Format matches EXACTLY what prompt-builder.ts expects:
-- • wall_colors: array of wall color options
-- • floor_materials: array of flooring options
-- • accent_colors: array of accent colors
-- • materials: array of primary materials
-- • finishes: array of finish types
-- • ambiance_keywords: array of mood/ambiance words
-- • lighting_style: single string describing lighting
-- • general_instructions: single string with style directive
-- =====================================================
...
-- SELECT COUNT(*) as total_styles FROM transformation_types;

-- Count styles with palettes
-- SELECT
--   tt.name,
--   tt.slug,
--   CASE WHEN sp.id IS NOT NULL THEN '✅' ELSE '❌' END as has_palette
...
-- FROM transformation_types tt
-- JOIN style_palettes sp ON sp.transformation_type_id = tt.id
-- ORDER BY tt.name;
